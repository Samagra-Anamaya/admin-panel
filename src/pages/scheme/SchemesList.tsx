...
const SchemesListMobileActions = () => (
    <TopToolbar>
        <ExportButton />
    </TopToolbar>
);

const SchemesListMobile = () => (
    <InfiniteList
        // sort={{ field: 'published_at', order: 'DESC' }}
        exporter={exporter}
        actions={<SchemesListMobileActions />}
    >
        <SimpleList
            primaryText={record => record.scheme_name}
            secondaryText={record => record.scheme_code}
        />
    </InfiniteList>
);
...
const SchemesList = () => {
    ...
    return isSmall ? <SchemesListMobile /> : <SchemesListDesktop />;
};
